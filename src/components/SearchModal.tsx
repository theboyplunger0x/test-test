...
function TierBadge({ tier }: { tier?: string }) {
  ...
  if (tier === "elite") return <span className="relative group/badge inline-flex items-center shrink-0"><svg width="13" height="13" viewBox="0 0 22 22" fill="none"><path d={SEAL} fill="#4C1D95"/><path d={CHECK} fill="#FACC15"/></svg>{tip("Not for everyone.")}</span>;
